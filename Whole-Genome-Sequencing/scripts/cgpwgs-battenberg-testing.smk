...
OUTPUT = WORK+"wgs_out_testBattenberg"
...
rule brass:
    ...
    shell:
        ...
        -t {input.tumor} \
        -n {input.normal} \
        -ss {OUTPUT}/{wildcards.tumor}/{PROTOCOL}_{wildcards.tumor}/{CNV_TOOL}/{wildcards.tumor}.samplestatistics.txt \
        -o {OUTPUT}/{wildcards.tumor}/{PROTOCOL}_{wildcards.tumor}/brass_{CNV_TOOL}' \
        2>&1 | tee {output}
        """
...
checkpoint battenberg:
    ...
    shell:
        ...
        # mkdir -p {OUTPUT}/{wildcards.tumor}/tmp
        #
        # cp {OUTPUT}/{wildcards.tumor}/{PROTOCOL}_{wildcards.tumor}/battenberg/{wildcards.tumor}.samplestatistics.txt \
        #    {OUTPUT}/{wildcards.tumor}/{PROTOCOL}_{wildcards.tumor}/battenberg/{wildcards.tumor}_vs_{wildcards.normal}.samplestatistics.txt
        #
